...
public class TeamController {
    ...
    @PostMapping
    public ResponseEntity<Team> createTeam(@RequestParam String name, @AuthenticationPrincipal String username) {
    ...
    public ResponseEntity<Void> addWatcherToTeam(@PathVariable Long teamId, @RequestParam Long userId) {
        try {
    ...
    public ResponseEntity<Void> removeWatcherFromTeam(@PathVariable Long teamId, @PathVariable Long userId) {
        try {
